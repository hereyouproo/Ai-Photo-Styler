  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (isRateLimitError) {
        ...
        setToastMessage("Rate limit reached.");
                ...
                <footer className="flex-shrink-0 p-4 pt-2 w-full max-w-4xl mx-auto">
                    <div className="glassmorphism rounded-2xl p-3 flex flex-col gap-3 transition-all duration-300">
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            />
                            <button onClick={handleGenerate} disabled={isLoading || (sourceFiles.length === 0 && !prompt.trim())} className="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-lg bg-blue-600 font-semibold text-white hover:bg-blue-500 disabled:bg-gray-700 disabled:cursor-not-allowed transition-colors">
                                {isLoading ? (
                                    <Spinner />
                                ) : (
